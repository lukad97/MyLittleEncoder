...
//    desEncryptFileCBC("test.txt", key1, IV);
//    desDecryptFileCBC("test_c.txt", key1, IV);

    tdesEncryptFileCBC("test.txt", key1, key2, key3, IV);
    tdesDecryptFileCBC("test_c.txt", key1, key2, key3, IV);
